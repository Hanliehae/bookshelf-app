...
function newBookToAdd(bookObject) {
  ...
  buttonToEdit.setAttribute("data-testid", "bookItemEditButton");
  ...
  buttonToDelete.setAttribute("data-testid", "bookItemDeleteButton");
  ...
  if (bookObject.isComplete) {
    ...
    buttonToUndo.setAttribute("data-testid", "bookItemIsCompleteButton");
    buttonToUndo.innerText = "Undo";

    buttonToUndo.addEventListener("click", function () {
      undoDone(bookObject.id);
    });
    buttonContainer.append(buttonToUndo, buttonToDelete, buttonToEdit);
  } else {
    const buttonToDone = document.createElement("button");
    buttonToDone.setAttribute("data-testid", "bookItemIsCompleteButton");
    ...
    buttonContainer.append(buttonToDone, buttonToDelete, buttonToEdit);
  }
  return container;
}
